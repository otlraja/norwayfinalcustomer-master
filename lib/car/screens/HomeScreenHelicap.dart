...
import 'detail_Screen_helicap.dart';
import 'detail_screen.dart';
const stylistData = [
  {
    'stylistName': 'Tetra Pak',
...
class HomeScreenHelicap extends StatefulWidget {
  @override
  _HomeScreenHelicapState createState() => _HomeScreenHelicapState();
}

class _HomeScreenHelicapState extends State<HomeScreenHelicap> {
                    ...
                    MaterialButton(
                      onPressed: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => DetailScreenHelicap(stylist: widget.stylist)));
                      },
                      color: Color(0xff4E295B),
                      shape: RoundedRectangleBorder(
