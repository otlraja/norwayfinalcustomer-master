...
import 'package:norwayfinalcustomer/Saloon/widgets/button.dart';
import 'package:norwayfinalcustomer/Saloon/widgets/date_column.dart';
import 'package:norwayfinalcustomer/Saloon/widgets/specialist_column_book.dart';

import '../uidata.dart';
import 'SaloonBookingScreen.dart';
...
class _BookPageState extends State<BookPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar:
      Container(
        height: MediaQuery.of(context).size.height/13.75,
        child: MyButton(btnText: "Book Appointment",
            onpressed: (){
              Navigator.of(context)
                  .push(MaterialPageRoute(builder: (_) => SaloonBooking()));
            }),
      ),
      appBar: AppBar(
        elevation: 0,
